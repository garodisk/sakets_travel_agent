...
# Change this if your default location is Chicago
DEFAULT_ORIGIN_IATA = os.getenv("DEFAULT_ORIGIN_IATA", "ORD")
...
if __name__ == "__main__":
    print(search_flights("Plan a 7 days Kansas City trip from Chicago"))
    print("\n" + "=" * 80 + "\n")
